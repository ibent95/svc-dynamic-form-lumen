...
class PublicationTypeModel extends Model
{
     ...
     * @var array
     */
    protected $with = ['publicationGeneralType'];

    public function publicationGeneralType()
    {
        return $this->hasOne(PublicationGeneralTypeModel::class, 'id', 'id_publication_general_type');
    }
