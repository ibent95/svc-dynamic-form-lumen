 ...
 */
class PublicationFormModel extends Model
{
     ...
     * @var string
     */
    protected $table = "publication_form";
     ...
     * @var array
     */
    protected $hidden = ['row_id', 'id', 'id_form_version', 'id_form_parent', 'id_publication_general_type', 'flag_active', 'create_user', 'created_at', 'update_user', 'updated_at'];
     ...
     * @var array
     */
    protected $with = ['formVersion'];

    public function formVersion(): HasOne
    {
        return $this->hasOne(PublicationFormVersionModel::class, 'id', 'id_form_version');
    }

    public function formParent(): HasOne
    {
        return $this->hasOne(PublicationFormModel::class, 'id', 'id_form_parent');
    }
