 ...
 */
class PublicationFormVersionModel extends Model
{
     ...
     * @var string
     */
    protected $table = "publication_form_version";
    ...
    public function publicationType(): HasOne
    {
        return $this->hasOne(PublicationTypeModel::class, 'id', 'id_publication_type');
    }

    public function publicationForms(): HasMany
    {
        return $this->hasMany(PublicationFormModel::class, 'id_form_version', 'id');
    }
